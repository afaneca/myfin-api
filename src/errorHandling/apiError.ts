export default class APIError extends Error {
  ...
  static notAuthorized(msg = "The owner of this request is not authorized to do so.", rationale?: string) {
    return new APIError(401, msg, rationale);
  }

  static forbidden(msg = "The owner of this request is not authorized to do so.", rationale?: string) {
