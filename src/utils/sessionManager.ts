...
const updateUserSessionKeyValue = async (
  username: string,
...
const updateUserTrustlimitValue = async (
  username: string,
  newTrustLimit: number,
  mobile = false
) => {
...
const checkIfSessionKeyIsValid = async (
  key: string,
  username: string,
  renewTrustLimit = true,
  mobile = false
) => {
